...
const JobListing = () => {
  ...
  return (
    <div
      className="container 2xl:px-20 mx-auto flex flex-col
     lg:flex-row max-lg:space-y-8 py-8"
    >
      {/* SideBar */}
              ...
              <div className="mb-4 text-gray-600">
                {searchFilter.title && (
                  <span
                    ...
                    bg-blue-50 border border-blue-300 px-4 py-1.5 rounded"
                  >
                    {searchFilter.title}
                    <img
                      onClick={(e) =>
                ...
                {searchFilter.location && (
                  <span
                    className=" ml-2 inline-flex items-center gap-2.5 
                    bg-red-50 border border-red-300 px-4 py-1.5 rounded"
                  >
                    {searchFilter.location}
                    <img
                      onClick={(e) =>
